      ...
      <div className="w-full px-4 mx-auto max-w-[1400px]">
        <div className="flex flex-wrap items-center">
          <div className="w-full md:w-2/3">
            <h1><i className="fas fa-edit mr-3"></i>成绩编辑</h1>
            <nav aria-label="breadcrumb" className="mt-2">
              <ol className="flex flex-wrap list-none p-0 mb-0">
                <li className="flex items-center"><Link href="/scores" className="text-white/50">成绩管理</Link><span className="mx-2 text-white/50">/</span></li>
                <li className="text-white">编辑成绩</li>
              </ol>
            </nav>
          </div>
